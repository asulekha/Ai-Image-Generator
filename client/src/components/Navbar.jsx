...
const Navbar = () => {
    ...
    return (
        <div className='flex items-center justify-between py-4'>
            <Link to='/'> <img src={assets.logo} alt="" className='inline-flex items-center gap-2 w-7 sm:w-8 lg:w-10' />
                <p className='text-lg font-semibold' >AI Imgae Generator</p>
            </Link>
            <div>
                {
                    user ?
                        <div className='flex items-center gap-3'>
                            ...
                            <div className='relative group'>
                                <img src={assets.profile} alt="" className='w-9 drop-shadow' />
